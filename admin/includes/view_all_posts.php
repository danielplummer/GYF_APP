    ...
    <tbody>
      ...
      while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        $new_date = date("m-d-Y", strtotime($post_date));  
          ...
          echo "<td class='text-center'><a href='posts.php?publish=$post_id' class='btn btn-success'>Publish</a></td>";
          echo "<td class='text-center'><a href='posts.php?unpublish=$post_id' class='btn btn-warning'>Unpublish</a></td>";
          echo "<td>
                  <div class='dropdown'>
