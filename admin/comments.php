  ...
  <tbody>
    ...
    while ($row = mysqli_fetch_assoc($select_comments)) {
      ...
      $new_comment_date = date("m-d-Y", strtotime($comment_date)); 
        ...
        echo "<td class='text-center'><a href='comments.php?approve=$comment_id' class='btn btn-success'>Approve</a></td>";
        echo "<td class='text-center'><a href='comments.php?unapprove=$comment_id' class='btn btn-warning'>Unapprove</a></td>";
